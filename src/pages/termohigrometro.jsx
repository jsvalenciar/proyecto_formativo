...
function Termohigrometro() {
  const [datosGenerales, setDatosGenerales] = useState({ servicio: '', ubicacion: '', nombreEquipo: 'TERMOHIGROMETRO', marca: '', modelo: '', serie: '', activo: '', fechaMantenimiento: '', lugarMantenimiento: '', tipoMantenimiento: { preventivo: false, correctivo: false, predictivo: false } });
  const [observaciones, setObservaciones] = useState('');
  const [tablas, setTablas] = useState({
    fisicaInstalacion: [{ item: 'Condiciones', resultado: '' }, { item: 'Limpieza', resultado: '' }, { item: 'Carcasa', resultado: '' }, { item: 'Cubiertas', resultado: '' }, { item: 'Accesorios', resultado: '' }, { item: 'Etiquetas', resultado: '' }, { item: 'Sensores', resultado: '' }, { item: 'Cables', resultado: '' }, { item: 'Conexiones', resultado: '' }, { item: 'Display', resultado: '' }, { item: 'Entrada', resultado: '' }],
    ...
    interfazUsuario: [{ item: 'Display temperatura', resultado: '' }, { item: 'Display humedad', resultado: '' }, { item: 'Botones', resultado: '' }, { item: 'Indicadores', resultado: '' }, { item: 'Alarmas', resultado: '' }, { item: 'Conectores', resultado: '' }, { item: 'Sensor', resultado: '' }, { item: 'General', resultado: '' }],
    ...
    pruebasDesempeno: [{ item: 'Lectura temperatura', resultado: '' }, { item: 'Lectura humedad', resultado: '' }, { item: 'Exactitud', resultado: '' }, { item: 'Respuesta', resultado: '' }, { item: 'Alarmas', resultado: '' }, { item: 'Software', resultado: '' }, { item: 'Hardware', resultado: '' }, { item: 'General', resultado: '' }]
  });
  ...
  return (
    <div className="formato">
      <header><div className="titulo"><h1>TERMOHIGROMETRO - MANTENIMIENTO</h1></div><div className="info-cabecera"><p>Versión: 1.0</p><p>Fecha: {new Date().toLocaleDateString()}</p></div></header>
